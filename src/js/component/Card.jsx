...
const Card = () => {
    return (
        <div class="container card-group p-3 gap-4">
  <div class="card">
    <img src="https://picsum.photos/id/227/500/325" class="card-img-top" alt="..."/>
    <div class="card-body">
  ...
  <div class="card">
    <img src="https://picsum.photos/id/211/500/325" class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title text-center">Card title</h5>
  ...
  <div class="card">
    <img src="https://picsum.photos/id/127/500/325" class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title text-center">Card title</h5>
  ...
  <div class="card">
    <img src="https://picsum.photos/id/345/500/325" class="card-img-top" alt="..."/>
    <div class="card-body">
      <h5 class="card-title text-center">Card title</h5>
      <p class="card-text text-center">This is a wider card with supporting text below as a natural lead-in to additional content. This card has even longer content than the first to show that equal height action.</p>
    </div>
